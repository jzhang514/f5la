---
title: Child Care Closures in California and Los Angeles County 
output:
  html_document:
    number_sections: no
    theme: sandstone
...
kable(table, 
    ...
    pack_rows("Permanent Center Closures", 1, 4, label_row_css = "background-color: #452F97; color: #fff;") %>%
      pack_rows("Family Child Care Home", 1, 2)%>%
  pack_rows("Child Care Center", 3, 4)%>%
      pack_rows("Seats Lost", 5, 8, label_row_css = "background-color: #452F97; color: #fff;")%>%

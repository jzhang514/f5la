...
hc<-hchart(internet, "column",
         hcaes(x=best_start, y=pct_broadband),
          tooltip = list(pointFormat = "Percentage of Households Internet: {point.pct_broadband:.1f}%<br>
                         Number of Households Internet: {point.tot_broadband}"))%>%
    ...
    hc_yAxis(title = list(text = ""), 
      ...
      formatter = JS("function () {
       ...
       plotLines = list(
      list(
        label = list(text = "LA County = 84.3%<br>", align = "left"),
        color = "#FF0000",
        width = 2,
        value = 84.5
      )

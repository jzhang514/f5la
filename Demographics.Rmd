  ...
  age%>%
    ...
    hc_yAxis(title = list(text = ""), 
      ...
      formatter = JS("function () {
       ...
       plotLines = list(
      list(
        label = list(text = "LA County = 6.2%<br>", align = "left", x=47, y=-10),
        color = "#FF0000",
        width = 2,
        value = 6.2,
        zIndex=5
                                ...
                                ifelse(pct_measure %in% 'pct_aian', 'Percent AIAN',
                                       ifelse(pct_measure %in% 'pct_asian', 'Percent Asian',
                                         ifelse(pct_measure %in% 'pct_nhpi', 'Percent Native Hawaiin/Pacific Islander',
                                                ifelse(pct_measure %in% 'pct_latinxcombo', 'Percent Latinx', ifelse(pct_measure %in% 'pct_combined', 'Percent Other/Two or More Races', "Blank"))))))))
...
<br>
<p class="round1">__Why this matters:__ Essential workers are earning incomes that are insufficient to meeting the fundamental needs of their children and families, despite shouldering the burden of the pandemic for families who can remain safe and earn higher incomes while working from home. Lower incomes automatically create constraints, forcing families to make impossible decisions on what to spend money on and sacrificing safety for job and income security.</p>
<br>
```{r cache=TRUE}

...
colnames = c("Best Start Geography", "ECE Unmet Need Amount Infant Toddlers", "ECE Unmet Need Among Pre-K Children", "Transit Users", "Uninsured Population", "Families with Access to Internet"),
style = "default",
          rownames = F, filter = "top",
         editable = FALSE, extensions = c("Buttons", "FixedColumns"),
          options = list(
...
Many Program Officers and Regional Network Grantees expressed the importance of having data points readily accessible to use during conversations with stakeholders. To view all of the data indicators as an excel, please click the link below.
